...
class SAMPLE(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        if os.path.exists(self.split_path):
            ...
            trainval_file = os.path.join(self.dataset_dir, 'synth')
            test_file = os.path.join(self.dataset_dir, 'real')
    ...
    def read_data(self, image_dir):
        label_int = {'2s1': 0, 'bmp2': 1, 'btr70': 2, 'm1': 3, 'm2': 4, 'm35': 5,
                     'm60': 6, 'm548': 7, 't72': 8, 'zsu23': 9}
        ...
        label_name = {'2s1': 0, 'bmp2': 1, 'btr70': 2, 'm1': 3, 'm2': 4, 'm35': 5,
                     'm60': 6, 'm548': 7, 't72': 8, 'zsu23': 9}
        ...
        for root, dirs, files in os.walk(image_dir):
            ...
            for file in files:
                if os.path.splitext(file)[1] == '.jpg' or os.path.splitext(file)[1] == '.png':
                    ...
                    idx = re.split('[/\\\]', impath).index('SAMPLE')
