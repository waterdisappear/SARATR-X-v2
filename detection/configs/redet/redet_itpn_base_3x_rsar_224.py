...
angle_version = 'le90'
# 官方 iTPN det 预训练权重（pixel itpn base），需放置到 ckpts/iTPN/
...
# 优化器：参考 pixel_itpn_GFL_sardet100k，AdamW + LayerDecay
optimizer = dict(
    _delete_=True,
    type='AdamW',
    lr=6e-5,
...
# 3x 36 epoch，CosineAnnealing 学习率
lr_config = dict(
    _delete_=True,
...
# 可选：混合精度与自动缩放 lr（与 sardet100k 一致）
