# Oriented RepPoints + iTPN_pixel（base）on SIVED，3x（36 epoch）
# 结构参考：configs/oriented_reppoints/oriented_reppoints_r50_fpn_1x_dota_le135.py
