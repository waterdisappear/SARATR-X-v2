# =============================================================================
# HRSID horizontal-bbox detection config (reference reproduction)
# GFL + iTPN-Base backbone (MMDetection style)
#
# NOTE / 说明:
# - Archived from the original experiment that produced the paper's HRSID numbers.
# - Targets MMDetection with the `iTPN_pixel` backbone (see `detection/`).
# - Absolute paths below must be adapted to your environment.
#
# 此配置为论文 HRSID 结果所用实验配置的存档（训练日志见本目录），
...
work_dir = './work_dirs/pixel_itpn_GFL_hrsid_jpg'
auto_resume = False
gpu_ids = range(0, 6)
