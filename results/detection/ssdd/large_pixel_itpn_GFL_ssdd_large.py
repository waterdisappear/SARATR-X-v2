# =============================================================================
# SSDD horizontal-bbox detection config (reference reproduction, iTPN-Large)
# GFL + iTPN-Large backbone (MMDetection style)
#
# NOTE / 说明:
# - Archived from the original experiment that produced the paper's SSDD
...
#
# 此配置为论文 SSDD（iTPN-Large）结果所用实验配置的存档，
...
work_dir = './work_dirs/pixel_itpn_GFL_ssdd_large'
auto_resume = False
gpu_ids = range(0, 6)
