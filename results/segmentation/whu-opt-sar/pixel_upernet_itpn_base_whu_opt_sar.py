# =============================================================================
# WHU-OPT-SAR semantic segmentation config (reference reproduction)
# UperNet + iTPN-Base (MMSegmentation 1.x / mmengine style)
#
# NOTE / 说明:
# - Archived from the original experiment that produced the paper's
#   WHU-OPT-SAR numbers (see the sibling training log in this folder).
...
#
# 此配置为论文 WHU-OPT-SAR 结果所用实验配置的存档（训练日志见本目录），
...
work_dir = './work_dirs/weijie_whu_1xb4_80k_6e-4'
model = dict(
    type='EncoderDecoder',
    data_preprocessor=dict(
        type='SegDataPreProcessor',
